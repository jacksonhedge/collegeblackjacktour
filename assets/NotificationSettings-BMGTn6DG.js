import{r as c,j as e,c as E,s as T,v as $,u as A,y as z,n as w,A as P,aA as B,ab as F,B as k,x as M,D as q,U as D,G as R,S as G,m as I,M as W}from"./main-CIF9t6XU.js";import{M as j}from"./mail-BthhqBKa.js";import{C as H}from"./circle-check-big-AqWX4NIq.js";import{S as Y}from"./save-CDQjKhTV.js";import{M as S}from"./message-square-Dsl2VSSP.js";import{C as L}from"./clock-chpOVBbq.js";const O=({userEmail:m="jacksonfitzgerald25@gmail.com"})=>{const[a,s]=c.useState(!1),[n,x]=c.useState(null),[f,l]=c.useState(""),u=async()=>{s(!0),x(null),l("");try{const r=new Date().toLocaleString(),{data:y,error:g}=await T.functions.invoke("send-notification",{body:{to:m,subject:`🎉 Bankroll Test Email - ${r}`,html:`
            <!DOCTYPE html>
            <html>
            <head>
              <meta charset="utf-8">
