...
import ESPNLeagueDetailsModal from './ESPNLeagueDetailsModal';
import PlatformImageService from '../../services/firebase/PlatformImageService';

const ESPNLeaguesList = () => {
  const { leagues, fetchLeagues, loading, error } = useESPN();
  const { user } = useAuth();
...
export default ESPNLeaguesList;
