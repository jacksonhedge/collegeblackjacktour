...
const LandingPage = () => {
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-gray-300 via-gray-400 to-gray-600 animate-gradient-xy pt-16">
      {/* Main Content */}
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] py-20 px-4">
        <div className="max-w-4xl w-full flex flex-col items-center space-y-12">
          ...
          />
          <h1 className="text-4xl md:text-6xl font-black text-gray-800 tracking-widest animate-float drop-shadow-[0_0_25px_rgba(0,0,0,0.1)] text-center">
            COMING SOON
          </h1>
        </div>
      </div>
      ...
      {/* Partners Section */}
      <div className="w-full bg-white/40 backdrop-blur-lg py-16">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {partners.map((partner) => (
              <div 
                key={partner.name}
                className="bg-white/70 hover:bg-white/90 rounded-xl flex items-center justify-center p-8 transition-all duration-300 aspect-video shadow-lg"
              >
                <img 
                  src={partner.logo} 
                  alt={partner.name} 
      ...
      {/* Info Section */}
      <div className="w-full bg-gray-700/80 backdrop-blur-lg py-12 px-4 mt-12">
