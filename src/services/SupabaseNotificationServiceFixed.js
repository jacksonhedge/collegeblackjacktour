...
class SupabaseNotificationServiceFixed {
  constructor() {
...
const supabaseNotificationServiceFixed = new SupabaseNotificationServiceFixed();
export default supabaseNotificationServiceFixed;